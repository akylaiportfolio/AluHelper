...
class SendGuideController: BaseController<SendGuidePresenter> {
   
    private lazy var toolbar: ToolbarView = {
        let view = ToolbarView()
        view.titleView.text = "Send guide"
        return view
    }()
...
extension SendGuideController: SendGuideDelegate {
    ...
    func showSussesd() {
        let alert = UIAlertController(title: "Success", message: "Your guide ad has been sent.", preferredStyle: .alert)
...
extension SendGuideController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
